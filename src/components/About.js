  ...
  return (
    <>
      ...
      <section className="about-us">
        <h2>Our Story</h2>
        <p>
          Welcome to GreenAcres Yardcare, your trusted partner for all your lawn and garden maintenance needs. We have been serving the local community for GreenAcres Yardcare years, and our passion for creating beautiful outdoor spaces is unmatched.
        </p>
